...
function loadNewTrack(index){
  ...
  //document.querySelector('.title-sideblock').innerHTML = listAudio[index].name
  //document.querySelector('.duration-sideblock').innerHTML = listAudio[index].duration
  document.getElementById('player-image').style.backgroundImage = listAudio[index].image
...
function ChangeVolume(value) { //Меняем громкость
